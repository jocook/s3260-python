...
if __name__ == "__main__":
    try:
        ...
        print "Creating vMedia Policy in UCS Central:" #% (template)
        ...
        mo = CimcvmediaMountConfigPolicy(parent_mo_or_dn="org-root", retry_on_mount_fail="yes", name="RHEL-7-3", descr="RHEL 7.3")
